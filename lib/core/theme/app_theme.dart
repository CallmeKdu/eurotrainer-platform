...
class AppTheme {
  static ThemeData get lightTheme {
    return ThemeData(
      useMaterial3: true,
      fontFamily: 'Public Sans', // Lembre-se de adicionar essa fonte no pubspec.yaml
      ...
      colorScheme: const ColorScheme(
        ...
        surfaceVariant: Color(0xFFE3E3DF),
        onSurfaceVariant: Color(0xFF4A4731),
        outline: Color(0xFF7B785F),
        outlineVariant: Color(0xFFCCC7AA),
      ),
      textTheme: const TextTheme(
        displayLarge: TextStyle(fontSize: 57, fontWeight: FontWeight.w600, height: 1.12, letterSpacing: -0.25),
        headlineLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.w600, height: 1.25, letterSpacing: 0),
        headlineMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.w500, height: 1.28, letterSpacing: 0),
        ...
        bodyMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, height: 1.42, letterSpacing: 0.25),
        labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, height: 1.42, letterSpacing: 0.1),
