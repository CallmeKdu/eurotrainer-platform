                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(flex: 1, child: _StatsCard()),
                      ],
                    ),
                    const SizedBox(height: 20),
                    ...
                    IntrinsicHeight(
                      child: Row(
                        ...
                        children: const [
                          Expanded(flex: 2, child: _CalendarCard()),
                          SizedBox(width: 20),
                          Expanded(flex: 1, child: _CertificatesCard()),
                        ],
                      ),
                    ),
                  ],
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            value:
                0.0, // Quando conectarmos com Firebase, isso virá do ViewModel
            backgroundColor: theme.colorScheme.primaryContainer,
